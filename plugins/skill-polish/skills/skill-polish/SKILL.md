...
If `$ARGUMENTS` contain `--auto-approve` or `-a`, skip picker and apply every proposed edit immediately. Note in summary: "auto-approve flag set, all N edits applied without prompt."
